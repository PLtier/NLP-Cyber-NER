    ...
    with mlflow.start_run(run_name="TokenModel_tiedEMB_sepLSTM_train"):
        ...
        for dataset_name in DATASETS:
            ...
            with mlflow.start_run(
                run_name=f"TokenModel_tiedEMB_sepLSTM_eval_{dataset_name}", nested=True
            ):
...
if __name__ == "__main__" and DEDUPLICATION == True:
    ...
    for intended_eval_dataset in DATASETS:
        ...
        with mlflow.start_run(
            run_name=f"train-TokenModel_tiedEMB_sepLSTM-eval-{intended_eval_dataset}"
        ):
            # Log hyperparameters
            hyperparams = {
                "BATCH_SIZE": BATCH_SIZE,
